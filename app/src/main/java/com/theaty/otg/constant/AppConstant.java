package com.theaty.otg.constant;
...
public class AppConstant {
    ...
    //http://123.56.233.48/mobile/index.php?act=member_evaluate&op=add&order_id=订单ID&key=用户key
    ...
    // 首页获取数据字段, 未处理nodone，已完成complete,应急维修emergency
